...
public abstract class ProductsApiService {
    ...
    public abstract Response editProduct(ProductRequest body,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getProduct(ProductRequest body,SecurityContext securityContext) throws NotFoundException;
